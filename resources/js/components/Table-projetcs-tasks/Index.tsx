...
export function DeleteTaskDialog({ isOpen, setIsOpen, processing, handleDelete }: DeleteTaskDialogProps) {
    return (
        <Dialog open={isOpen} onOpenChange={setIsOpen}>
            <DialogContent>
                <DialogHeader>
                    <DialogTitle>Confirmer la suppression</DialogTitle>
                    <DialogDescription>Cette action supprimera définitivement la tâche . Voulez-vous continuer ?</DialogDescription>
                </DialogHeader>
