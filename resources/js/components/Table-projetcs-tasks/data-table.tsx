...
import { AddTaskModale } from '../Projects/Taches';
export function DataTable({ columns, data, project_id, users }) {
    ...
    const table = useReactTable({
        ...
        globalFilterFn: (row, _, filterValue) => {
            const valuesToFilter = [row.getValue('description')];
    ...
    return (
        <Fragment>
            ...
            <AddTaskModale isOpen={openTaskFormModale} setIsOpen={setOpenTaskFormModale} project_id={project_id} users={users} />
        </Fragment>
    );
}
